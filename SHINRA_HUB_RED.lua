...
-- ============================================================
-- SHINRA HUB - RED FIRE EDITION (SAVE BUTTON FIXED)
...
local function saveSettings()
    ...
    LP:SetAttribute("SHINRA_HUB_Saved", encoded)
    _G.SHINRA_HUB_SavedSettings = encoded
...
local function loadSettings()
    local saved = LP:GetAttribute("SHINRA_HUB_Saved")
    if not saved or saved == "" then
        if _G.SHINRA_HUB_SavedSettings then saved = _G.SHINRA_HUB_SavedSettings end
    end
...
-- COLORS
-- ============================================================
local PINK_MAIN = Color3.fromRGB(255, 40, 40)
...
local C = {
    ...
    ACCENT      = PINK_MAIN,
    ACCENT_DIM  = Color3.fromRGB(220, 30, 30),
...
local function showToast(msg, isError)
    ...
    toastFrame.BackgroundColor3 = isError and Color3.fromRGB(255, 60, 60) or Color3.fromRGB(30, 30, 30)
...
local function makeToggleRow(parent, labelText, defaultValue, callback)
    ...
    label.Size = UDim2.new(0.52, 0, 0.88, 0)
...
local function makeInputRow(parent, labelText, defaultValue, minVal, maxVal, callback)
    ...
    local label = Instance.new("TextLabel", row)
    label.Size = UDim2.new(0.48, 0, 0.88, 0)
    label.Position = UDim2.new(0, 12, 0, 0)
    label.BackgroundTransparency = 1
    label.Text = labelText
    label.TextColor3 = C.TEXT
